...
#ifndef ALIANALYSISTASKMIXEDHARMONICSFORWARD_H
#define ALIANALYSISTASKMIXEDHARMONICSFORWARD_H
...
class AliFlowAnalysisWithMixedHarmonicsForward;

//================================================================================================================

class AliAnalysisTaskMixedHarmonicsForward : public AliAnalysisTaskSE{
 public:
  AliAnalysisTaskMixedHarmonicsForward();
  AliAnalysisTaskMixedHarmonicsForward(const char *name, Bool_t useParticleWeights=kFALSE);
  virtual ~AliAnalysisTaskMixedHarmonicsForward(){}; 
 ...
 private:
  AliAnalysisTaskMixedHarmonicsForward(const AliAnalysisTaskMixedHarmonicsForward& aatmh);
  AliAnalysisTaskMixedHarmonicsForward& operator=(const AliAnalysisTaskMixedHarmonicsForward& aatmh);
  
  AliFlowEventSimple *fEvent; // the input event
  AliFlowAnalysisWithMixedHarmonicsForward *fMH; // mixed harmonics object
  ...
  ClassDef(AliAnalysisTaskMixedHarmonicsForward, 1); 
};
