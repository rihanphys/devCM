void AddTaskCMEAnalysisForward(Bool_t isPbPb = kTRUE,
  ...
  */
  static const Int_t nCentralities = 2;
  Double_t gCentrality[nCentralities] = {5,40};
  ...
  AliAnalysisTaskMixedHarmonicsForward *taskMHLS[nCentralities];
  AliAnalysisDataContainer *coutputMHLS2[nCentralities];
  AliAnalysisTaskMixedHarmonicsForward *taskMHLS2[nCentralities];
  AliAnalysisDataContainer *coutputMHUS[nCentralities];
  AliAnalysisTaskMixedHarmonicsForward *taskMHUS[nCentralities];
  AliAnalysisDataContainer *coutputMHUS2[nCentralities];
  AliAnalysisTaskMixedHarmonicsForward *taskMHUS2[nCentralities];
  ...
  for(Int_t iCentralityBin = 0; iCentralityBin < nCentralities - 1; iCentralityBin++) {
    ...
    if(gRunMHLS) {
      ...
      taskMHLS[iCentralityBin] = new AliAnalysisTaskMixedHarmonicsForward(Form("TaskMixedHarmonicsLS_%s",outputSlotNameMHLS[iCentralityBin].Data()),kFALSE);
      ...
      taskMHLS2[iCentralityBin] = new AliAnalysisTaskMixedHarmonicsForward(Form("TaskMixedHarmonicsLS_%s",outputSlotNameMHLS2[iCentralityBin].Data()),kFALSE);
    ...
    if(gRunMHUS) {
      ...
      taskMHUS[iCentralityBin] = new AliAnalysisTaskMixedHarmonicsForward(Form("TaskMixedHarmonicsLS_%s",outputSlotNameMHUS[iCentralityBin].Data()),kFALSE);
      ...
      taskMHUS2[iCentralityBin] = new AliAnalysisTaskMixedHarmonicsForward(Form("TaskMixedHarmonicsLS_%s",outputSlotNameMHUS2[iCentralityBin].Data()),kFALSE);
