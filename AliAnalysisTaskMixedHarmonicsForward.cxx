...
#include "AliAnalysisTaskMixedHarmonicsForward.h"
#include "AliFlowAnalysisWithMixedHarmonicsForward.h"

using std::cout;
using std::endl;
ClassImp(AliAnalysisTaskMixedHarmonicsForward)

//================================================================================================================

AliAnalysisTaskMixedHarmonicsForward::AliAnalysisTaskMixedHarmonicsForward(const char *name, Bool_t useParticleWeights): 
...
{
 // constructor
 //cout<<"AliAnalysisTaskMixedHarmonicsForward::AliAnalysisTaskMixedHarmonicsForward(const char *name, Bool_t useParticleWeights)"<<endl;
...
AliAnalysisTaskMixedHarmonicsForward::AliAnalysisTaskMixedHarmonicsForward(): 
AliAnalysisTaskSE(),
fEvent(NULL),
fMH(NULL),
fListHistos(NULL),
...
{
 // Dummy constructor
 //cout<<"AliAnalysisTaskMixedHarmonicsForward::AliAnalysisTaskMixedHarmonicsForward()"<<endl;
}

//================================================================================================================

void AliAnalysisTaskMixedHarmonicsForward::UserCreateOutputObjects() 
{
 // Called at every worker node to initialize
 //cout<<"AliAnalysisTaskMixedHarmonicsForward::UserCreateOutputObjects()"<<endl;

 // Analyser:
 fMH = new AliFlowAnalysisWithMixedHarmonicsForward();
...
} // end of void AliAnalysisTaskMixedHarmonicsForward::UserCreateOutputObjects() 

//================================================================================================================

void AliAnalysisTaskMixedHarmonicsForward::UserExec(Option_t *) 
{
 // main loop (called for each event)
 fEvent = dynamic_cast<AliFlowEventSimple*>(GetInputData(0));

  std::cout<<"\n*********************\n called Local AnalysisTask \n************************\n"<<std::endl;
...
void AliAnalysisTaskMixedHarmonicsForward::Terminate(Option_t *) 
{
...
} // end of void AliAnalysisTaskMixedHarmonicsForward::Terminate(Option_t *)
