...
#ifndef ALIFLOWANALYSISWITHMIXEDHARMONICSFORWARD_H
#define ALIFLOWANALYSISWITHMIXEDHARMONICSFORWARD_H
...
{
 public:
  AliFlowAnalysisWithMixedHarmonicsForward();
  virtual ~AliFlowAnalysisWithMixedHarmonicsForward(); 
 ...
 private:
  AliFlowAnalysisWithMixedHarmonicsForward(const AliFlowAnalysisWithMixedHarmonicsForward& afawQc);
  AliFlowAnalysisWithMixedHarmonicsForward& operator=(const AliFlowAnalysisWithMixedHarmonicsForward& afawQc); 
  ...
  ClassDef(AliFlowAnalysisWithMixedHarmonicsForward, 0);
